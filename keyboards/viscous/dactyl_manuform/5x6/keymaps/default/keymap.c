...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT_5x6(
     ...
     LOWER, KC_Z  , KC_X  , KC_C  , KC_V  , KC_B  ,                           KC_N  , KC_M  ,KC_COMM,KC_DOT ,KC_SLSH,KC_BSLASH,
     KC_MUTE,                 KC_LBRC,KC_RBRC,                                                       KC_BSLS, KC_EQL, KC_MUTE,
                                      KC_LCTL, LSFT_T(KC_ENT),                 KC_SPC, LT(RAISE, KC_BSPC),
                                      LT(LOWER, KC_DEL), _______,              _______,  KC_DEL,
  ...
  [_MAC] = LAYOUT_5x6(
     ...
     LOWER, KC_Z  , KC_X  , KC_C  , KC_V  , KC_B  ,                           KC_N  , KC_M  ,KC_COMM,KC_DOT ,KC_SLSH,KC_BSLASH,
     KC_MUTE,                 KC_LBRC,KC_RBRC,                                                       KC_BSLS, KC_EQL, KC_MUTE,
                                      KC_LGUI, LSFT_T(KC_ENT),            KC_SPC,  LT(RAISE, KC_BSPC),
                                      LT(LOWER, KC_DEL), _______,              _______,  KC_DEL,
