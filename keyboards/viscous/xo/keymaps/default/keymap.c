...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_DEFAULT] = LAYOUT( /* qwerty */
    ...
    KC_LCTL,  KC_LGUI, KC_LALT, TO(_MAC), KC_LCTL, KC_ENT, KC_LALT,   LT(_LOWER, KC_DEL),   LSFT_T(KC_SPC),  LT(_RAISE, KC_BSPC),  KC_BSLS, KC_EQL, KC_BSLS,  KC_RGUI
  ),
    ...
    KC_LSFT,  KC_A,    KC_S,    KC_D,    KC_F,    KC_G, KC_MUTE,               KC_H, KC_J, KC_K,    KC_L,    KC_SCLN, KC_QUOT ,
    KC_LSFT,  KC_Z,    KC_X,    KC_C,    KC_V,    KC_B, KC_RGUI,   KC_GRV,     KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_EQL ,
    KC_LCTL,  KC_LGUI, KC_LALT, TO(_DEFAULT), KC_LGUI, KC_ENT, KC_LALT,   LT(_LOWER, KC_DEL),   LSFT_T(KC_SPC),  LT(_RAISE, KC_BSPC),  KC_BSLS, KC_EQL, KC_BSLS,  KC_RGUI
  ), 

    [_GAME] = LAYOUT(
    KC_ESC,  KC_NO  , KC_1  , KC_2  , KC_3  , KC_4  ,                     KC_6,    KC_7,    KC_8,    KC_9,    KC_0,   TO(_DEFAULT)   ,
    KC_TAB,   KC_TAB  , KC_Q  , KC_W  , KC_E  , KC_R  ,                   KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_MINS ,
    KC_LSFT,   KC_LSFT,  KC_A,    KC_S,    KC_D, KC_F,   KC_NO,         KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT ,
    KC_LSFT,   KC_LSFT,  KC_Z,    KC_X,    KC_C,    KC_V,  KC_SPC,   KC_SPC,   KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_EQL ,
    KC_LCTL, KC_LCTL,  KC_LALT, KC_LALT, KC_LCTL  , KC_SPC  , KC_SPC  ,  KC_SPC  ,  KC_NO  , LT(_RAISE, KC_BSPC)  , KC_NO  , KC_NO  , KC_NO  , KC_NO
  ),
