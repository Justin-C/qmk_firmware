...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_DEFAULT] = LAYOUT( /* qwerty */
    ...
    KC_LSFT,  KC_A,    KC_S,    KC_D, LSFT_T(KC_F), KC_G, KC_MUTE,             KC_H,  LSFT_T(KC_J), KC_K,    KC_L,    KC_SCLN, KC_QUOT ,
    KC_LSFT,  KC_Z,    KC_X,    KC_C,    KC_V,    KC_B, KC_RGUI,   KC_B,       KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_LBRC ,
    KC_LCTL,  KC_LGUI, KC_LALT, KC_GRV, KC_LCTL, LT(_RAISE, KC_ENT), KC_BSPC,   KC_ENT,   KC_SPC,  LT(_LOWER, KC_BSPC),  KC_MINS, KC_QUOT, KC_ENT,  KC_RGUI
  ),

  [_LOWER] = LAYOUT(
    TO(_DEFAULT),  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,                       KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11  ,
    KC_TRNS,       KC_TRNS, KC_TRNS, KC_LPRN, KC_RPRN, KC_TRNS,                     KC_F12,  KC_TRNS, KC_UP,   KC_TRNS, KC_TRNS, KC_TRNS ,
