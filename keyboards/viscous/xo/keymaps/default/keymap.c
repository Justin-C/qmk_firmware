...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_DEFAULT] = LAYOUT( /* qwerty */
    ...
    KC_LSFT,  KC_A,    KC_S,    KC_D,    KC_F,    KC_G, KC_MUTE,             KC_H,  LSFT_T(KC_J), KC_K,    KC_L,    KC_SCLN, KC_QUOT ,
    KC_LSFT,  KC_Z,    KC_X,    KC_C,    KC_V,    KC_B, KC_RGUI,   KC_GRV,       KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_EQL ,
    KC_LCTL,  KC_LGUI, KC_LALT, KC_GRV, KC_LCTL, LSFT_T(KC_ENT), KC_LALT,   LT(_RAISE, KC_DEL),   KC_SPC,  LT(_LOWER, KC_BSPC),  KC_MINS, KC_3, KC_ENT,  KC_RGUI
  ),

  [_LOWER] = LAYOUT(
    KC_TRNS,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,                       KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11  ,
    KC_TRNS,       KC_TRNS, KC_TRNS, KC_LPRN, KC_RPRN, KC_TRNS,                     KC_F12,  KC_TRNS, KC_UP,   KC_TRNS, KC_TRNS, KC_SLEP ,
  ...
  [_RAISE] = LAYOUT(
    KC_TRNS,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,                       KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11  ,
    KC_TRNS,       KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,                     KC_F12,  KC_7, KC_8, KC_9, KC_TRNS, KC_SLEP ,
  ...
  [_GAME] = LAYOUT(
    ...
    KC_NO,   KC_LSFT,  KC_A,    KC_S,    KC_D, KC_F  ,   KC_NO,                     KC_NO  , KC_NO  , KC_NO  , KC_NO  , KC_NO  , KC_NO   ,
    KC_NO,   KC_LSFT,  KC_Z,    KC_X,    KC_C,    KC_V,    KC_SPC,   KC_SPC,  KC_NO  , KC_NO  , KC_NO  , KC_NO  , KC_NO  , KC_NO   ,
    KC_LCTL, KC_LCTL,  KC_LGUI, KC_LALT, KC_LCTL  , KC_SPC  , KC_SPC  ,  KC_SPC  ,  KC_NO  , KC_NO  , KC_NO  , KC_NO  , KC_NO  , TO(_DEFAULT)
  ),
